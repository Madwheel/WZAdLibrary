...
public class AdCountDownView extends View {
    ...
    public AdCountDownView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray type = context.obtainStyledAttributes(attrs, R.styleable.AdCountDownView);
        defaultText = type.getString(R.styleable.AdCountDownView_defaultText);
        textColor = type.getColor(R.styleable.AdCountDownView_textColor, Color.WHITE);
        textSize = type.getDimensionPixelSize(R.styleable.AdCountDownView_textSize, 15);
        roundColor = type.getColor(R.styleable.AdCountDownView_roundColor, Color.RED);
        roundWidth = type.getFloat(R.styleable.AdCountDownView_roundWidth, 6f);
        roundProgressColor = type.getColor(R.styleable.AdCountDownView_roundProgressColor, Color.WHITE);
        roundStyle = type.getInt(R.styleable.AdCountDownView_roundStyle, 0);
        type.recycle();
    }
